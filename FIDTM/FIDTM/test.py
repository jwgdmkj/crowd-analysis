...
# python3 test.py --dataset ShanghaiB --pre ./weights/model_best.pth --gpu_id 0 --visual True
...
######################### mine ##############################################
# Objective: ground_truth 없이 실행시키기
def main(args):
...
def generate_bounding_boxes(kpoint, fname):
    ...
    Img_data = cv2.imread(
        '/workspace/FIDTM/dataset/ShanghaiTech/part_B_final/test_data/images/' + fname[0])
