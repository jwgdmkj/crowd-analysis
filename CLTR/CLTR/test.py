# https://github.com/dk-liang/CLTR
# TEST : python test.py --dataset nwpu --pre ./CLTR/weight/model.pth --gpu_id 0,1
# Video demo : python3 video_demo.py --video_path ./sample/crowdsample1.mp4 --num_queries 700 --pre ./weight/video_model.pth
