...
def parse_args():
    ...
    parser.add_argument('--data-dir', default='./UCF-QNRF_ECCV18/processed',
                        help='training data directory')
    parser.add_argument('--save-dir', default='./weights/model.pth',
    ...
    for inputs, count, name in dataloader:
        ...
        if h >= 3584 or w >= 3584:
            ...
            with torch.set_grad_enabled(False):
                ...
                pcolormesh(outputs)
                print('count' + str(torch.sum(outputs).item()))
